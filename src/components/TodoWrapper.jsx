			...
			{currentListName && (
				<div className="flex flex-col items-center bg-[#230e28] text-[#ffe4f9] p-4 rounded-xl shadow-md w-full sm:w-[650px]">
						...
						<div className="">
							{editingListName === currentListName ? (
								<div className="flex space-x-2 w-full">
									{/* Rename input field */}
									<input
										className="bg-gray-700 text-white px-2 rounded-xl text-2xl font-bold w-full"
										value={newListName}
										maxLength={28}
								...
								<div  className="flex space-x-2 w-full">
									...
									{/* Edit button */}
									<button
										className="text-[#230e28] bg-[#ffe4f9] hover:bg-[#230e28] hover:text-yellow-400 rounded-full p-2 ml-auto w-fit"
										onClick={() => {
									...
									{/* Delete Button */}
									<button
										className="text-[#230e28] bg-[#ffe4f9] hover:bg-[#230e28] hover:text-red-500 px-2 rounded-full p-2 w-fit"
					...
					<div className="flex items-center text-center justify-between my-4">
						<select
							className="form-select bg-[#ffe4f9] text-[#230e28] py-2 px-4 rounded-xl"
