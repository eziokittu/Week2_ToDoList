...
const TodoListAddButton = ({addTodoList}) => {
  return (
    <div
      onClick={addTodoList}
      className="fixed flex flex-col justify-center items-center right-0 bottom-16 cursor-pointer sm:bottom-14 bg-[#ffe4f9]/20 hover:bg-[#ffe4f9] rounded-tl-xl border-t-2 border-l-2 border-[#230e28] group"
    >
