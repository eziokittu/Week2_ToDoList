...
export const Todo = ({ task, deleteTodo, editTodo, toggleComplete }) => {
  return (
    <div className=" w-full relative flex gap-2 items-center justify-center bg-[#230e28] rounded-xl">
      {task.completed && (
        <p className='absolute left-4 z-20 pointer-events-none'>
          <svg className="w-8 h-8 xsm:w-8 xsm:h-8" fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 335.765 335.765" xmlSpace="preserve"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <polygon points="311.757,41.803 107.573,245.96 23.986,162.364 0,186.393 107.573,293.962 335.765,65.795 "></polygon> </g> </g> </g></svg>
        </p>
      )}

      {/* Task */}
      <p
        className={`${task.completed ? 'line-through text-[#ffe4f955]' : ''} cursor-pointer w-full m-2 mr-auto break-all whitespace-pre-wrap  p-2 rounded-xl bg-[#3d2243] text-[#ffe4f9]`}
